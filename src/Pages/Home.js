...
const ProfileSection = ({ profilePhoto, userName, userDesc }) => (
  <section className="portTitle" id="home">
    {profilePhoto && <img className="profile-img" src={profilePhoto} alt="GitHub profile" />}
    <section className="info">
      <h1>{userName.toUpperCase()}</h1>
      <hr />
      <p>{userDesc}</p>
      <container className="linksContainer">
      <a className="linkStyle" href="#home">Início</a>
      <a className="linkStyle" href="#projects">Projetos</a>
      <a className="linkStyle" href="#footer">Contato</a>
      </container>
    </section>
  </section>
);
